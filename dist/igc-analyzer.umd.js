(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('lodash'), require('simple-statistics')) :
	typeof define === 'function' && define.amd ? define(['lodash', 'simple-statistics'], factory) :
	(global = global || self, global.IGCAnalyzer = factory(global._, global.ss));
}(this, function (_, ss) { 'use strict';

	_ = _ && _.hasOwnProperty('default') ? _['default'] : _;
	ss = ss && ss.hasOwnProperty('default') ? ss['default'] : ss;
